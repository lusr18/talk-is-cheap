...
def main():
    ...
    with st.sidebar:    
        ...
        bot_types = ["DBBot", "RoutineBot", "SuggestionsBot"]
        bot_type_emojis = ["🤖", "🤖", "🤖"]
